...
{
    private const string Repository = "VoidDel/RN_FlashTool";
    ...
    private static string ExecutableName => OperatingSystem.IsWindows() ? "RnFlashTool.exe" : "RnFlashTool";

    /// <summary>
    /// 发行包的命名规则见 .github/workflows/release.yml：
    /// <c>RnFlashTool-&lt;版本&gt;-&lt;RID&gt;.zip|tar.gz</c>。
    /// </summary>
